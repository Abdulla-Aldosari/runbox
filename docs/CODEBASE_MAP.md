...
| `getWorkspaceDataFilePath(fsPath?)`            | fn    | Returns the `.vscode/terminal-recipes.data.json` path inside `fsPath` (or inside the first workspace folder if `fsPath` is omitted/null). Returns `null` if no workspace is open.                                                                                                                                                                                                                                                         |
...
| ---------- | ------------------------------------------------ | --------------------------------------------------------------------- |
| **Local**  | `.vscode/terminal-recipes.data.json` (workspace) | Value saved per-workspace; shown when that workspace is open          |
| **Global** | `~/.vscode-terminal-recipes/data.json`           | Value shared across all workspaces                                    |
