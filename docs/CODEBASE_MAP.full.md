...
> Auto-generated by `build-codebase-map.js`. Read-only reference for GitHub. AI clients should use `docs/CODEBASE_MAP.md` and the individual files under `docs/codebase-map/` instead.
